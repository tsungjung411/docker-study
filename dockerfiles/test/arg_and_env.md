...
RUN echo [1] >> env_author_1_1=env_author_1_1   # 是字串，不是變數
RUN echo [1] >> env_author_1_1=$env_author_1_1  # 是變數，不是字串
RUN echo [1] >> env_author_1_2=env_author_1_2   # 是字串，不是變數
RUN echo [1] >> env_author_1_2=$env_author_1_2  # 是變數，不是字串
...
ARG env_author_4=arg_tj_tsai_4    # 不會新增到 env 環境變數
ENV env_author_4_1=env_author_4    # 是字串，不是變數
ENV env_author_4_2=$env_author_4   # 是變數，不是字串
...
ARG env_author_5=arg_tj_tsai_5    # 不會新增到 env 環境變數
ENV env_author_5_1=env_author_5    # 是字串，不是變數
ENV env_author_5_2=$env_author_5   # 是變數，不是字串
